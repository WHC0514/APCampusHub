...
$roomMainStatus = $room['status']; // from room table
...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/staff/manage_room_detail.css">
</head>
<body>
...
<div class="topbar profile-topbar">
    ...
    <div class="profile-topbar-left">
        ...
        <a href="manage_rooms.php" class="back-btn">
...
<div class="room-details-container">
    ...
    <div class="room-right">
        ...
        <!-- ROOM TYPE + STATUS (ONLY ADDITION) -->
