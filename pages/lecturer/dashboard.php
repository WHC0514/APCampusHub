...
/* Get lecturer profile photo */
$sql = "SELECT profile_photo FROM lecturer WHERE user_id = ?";
    ...
    <div class="dashboard-content">
        ...
        <div class="card-grid">
            ...
            <div class="dashboard-card">
                ...
                <img src="../../assets/images/control.jpg" alt="Control" class="card-image">
                ...
                <div class="card-body">
                    ...
                    <p>
                        Easy control IOT device like projectors,
                        lights, and aircond in our rooms.
                    </p>
