...
<body>
    ...
    <div class="room-filter-section">
        ...
        <form method="GET" class="filter-form">
            ...
            <!-- My Bookings Button -->
            <a href="../booking_room/my_bookings.php" class="my-bookings-btn">
                My Bookings
            </a>
                ...
                <div class="room-card">
                    ...
                    <div class="room-info">
                        ...
                        <div class="room-btn-group">
                            ...
                            <a href="../booking_room/room_detail.php?room_id=<?php echo $room['room_id']; ?>" class="view-btn">

                                View Details

                            </a>

                            <a href="../booking_room/book_room.php?room_id=<?php echo $room['room_id']; ?>" class="book-btn">
